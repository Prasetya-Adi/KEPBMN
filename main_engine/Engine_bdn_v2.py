...
para = document.add_paragraph('Barang-barang Kena Cukai berupa ' +
                              jumlah_satuan_jenis+' dengan rincian:\n', style='KEP-2')
...
para = document.add_paragraph("adalah barang-barang hasil penindakan karena pelanggaran terhadap Undang-Undang Nomor 11 Tahun 1995 tentang Cukai sebagaimana telah diubah dengan Undang-Undang Nomor 39 tahun 2007, sesuai dengan Surat Bukti Penindakan nomor "+no_sbp_full+" tanggal "+tgl_sbp+".", style='KEP-2')
...
document.save('engine_bdn_v2.docx')
